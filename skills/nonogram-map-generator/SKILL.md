...
description: 컬러 노노그램 맵 데이터 생성 스킬. 사용자가 "노노그램 생성", "노노그램 맵 만들어줘", "[단어] 노노그램", "퍼즐 맵 생성" 등을 요청할 때 사용. 텍스트(단어)를 기반으로 25x20 컬러 노노그램 맵 데이터를 JSON 형식으로 생성하고 검증함.
---
...
3. **그리드 디자인**: 25x20 픽셀아트 형태로 해당 주제 표현
